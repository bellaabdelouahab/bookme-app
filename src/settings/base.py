...
# Build paths
# __file__ is at: src/settings/base.py
# parent = src/settings
# parent.parent = src
BASE_DIR = Path(__file__).resolve().parent.parent
# ROOT_DIR is the project root (contains .env, src/, docs/, etc.)
...
TENANT_APPS = [
    "django.contrib.contenttypes",
    "django.contrib.auth",
    # Tenant-specific apps (base_start template)
    "base_start.services",
    "base_start.staff",
...
MIDDLEWARE = [
    ...
    "tenants_core.core.middleware.DynamicAllowedHostsMiddleware",
    ...
    "tenants_core.core.middleware.TenantAdminAccessMiddleware",
    "django.contrib.messages.middleware.MessageMiddleware",
    "django.middleware.clickjacking.XFrameOptionsMiddleware",
    "tenants_core.core.middleware.TenantContextMiddleware",
    "tenants_core.core.middleware.StructuredLoggingMiddleware",
]
...
AUTHENTICATION_BACKENDS = [
    "django.contrib.auth.backends.ModelBackend",  # Keep for superuser auth
    "tenants_core.rbac.backends.TenantRolePermissionBackend",  # Tenant RBAC
]
...
REST_FRAMEWORK = {
    ...
    "EXCEPTION_HANDLER": "tenants_core.core.exceptions.custom_exception_handler",
...
# config to server http not https
